...
const Blog = ({ direction = 1 }) => {
  ...
  return (
    <main
      ref={pageRef}
      className="h-screen overflow-hidden text-[#171717]"
    >
      <div className="mx-auto flex h-full w-full max-w-8xl flex-col px-5 py-10 sm:px-8 lg:px-10 lg:py-14">
        <div className="grid min-h-0 flex-1 gap-8 overflow-hidden lg:grid-cols-[250px_1fr]">
          ...
          <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            <div
              ref={postsRef}
              className="min-h-0 flex-1 overflow-y-auto pr-2 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-neutral-300"
            >
