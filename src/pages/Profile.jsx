  ...
  return (
    <>
              ...
              <div className="flex min-w-0 flex-col gap-4">
                ...
                >
                  ...
                  <div className="relative rounded-2xl border-2 border-black bg-white p-4">
                    ...
                    <div
                      className="flex gap-3 overflow-x-auto p-1 pb-3 scrollbar-hide"
                      onWheel={(event) => {
                        if (event.deltaY !== 0) {
                      ...
                      {filteredSkills.map((skill) => (
                        ...
                        >
                          <div className="relative flex h-25 w-25 flex-col items-center justify-center rounded-xl border-2 border-black bg-white transition-all duration-300 group-hover:-translate-y-1">
                            ...
                            <span className="mt-2 max-w-20 truncate text-center text-[12px] font-black uppercase tracking-[-0.02em]">
                              {skill.name}
                            </span>
                          </div>
                        </div>
              ...
              <div className="flex min-w-0 flex-col gap-4">
                ...
                >
                  ...
                  >
                    ...
                    <a
                      href={`mailto:${EMAIL}`}
                      className={`group/email mt-6 inline-flex max-w-full items-center gap-3 rounded-full border-2 border-black bg-white px-4 py-2.5 text-[10px] font-black tracking-[-0.03em] shadow-[3px_3px_0_#000] transition-all duration-300 hover:-translate-y-1 hover:bg-[#fff21c] hover:shadow-[5px_5px_0_#000] sm:px-5 sm:py-3 sm:text-[20px] ${FOCUS_RING}`}
                    >
                ...
                >
                  <div className="absolute inset-0 translate-x-1.5 translate-y-1.5 rounded-2xl border-2 border-black bg-[#fff21c]" />

                  <div className="relative flex flex-col rounded-2xl border-2 border-black bg-white p-4">
                    <div
                      className="flex gap-3 overflow-x-auto overflow-y-hidden p-1 pb-3"
                      onWheel={(event) => {
                        if (event.deltaY !== 0) {
                          event.currentTarget.scrollLeft += event.deltaY;
                          event.preventDefault();
                        ...
                        >
                          <div className="relative h-full overflow-hidden rounded-xl border-2 border-black bg-white transition-transform duration-300 group-hover:-translate-y-1">
                            ...
                            <div className="absolute inset-x-4 bottom-4">
                              <span className="block text-[12px] font-black uppercase leading-tight tracking-[-0.03em] text-white sm:text-[18px]">
                                {certificate.title}
                              </span>

                              <span className="mt-1 block text-[12px] font-bold uppercase tracking-[0.15em] text-white/80">
      ...
      {selectedCertificate ? (
        ...
        >
          <div
            className="relative max-h-[130vh] w-full max-w-5xl overflow-y-auto rounded-2xl border-2 border-black bg-[#f7f7f5] shadow-[6px_6px_0_#fff21c]"
          ...
          >
            <button
              ...
              className="absolute right-3 top-3 z-10 flex h-10 w-10 items-center justify-center rounded-full border-2 border-black bg-[#ff4545] transition-transform duration-200 hover:rotate-90"
            >
              <X size={19} strokeWidth={3} />
            </button>

            <div className="grid md:grid-cols-[7.15fr_2.55fr]">
